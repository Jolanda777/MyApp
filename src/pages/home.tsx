  ...
  return (
    <div className="app-container">
      <header className="app-header">
        ...
        <NavButton icon={faSignOut} onClick={() => handleNavigation("/")} />

        <ThemeToggleButton theme={theme} toggleTheme={toggleTheme} />
      </header>

      <h3 className="greeting-1">Filter by Genre</h3>
          ...
          {carouselItems.map((item, idx) => (
            <Carousel.Item key={idx}>
              ...
              <Carousel.Caption>
                ...
                <h2>{item.captionText}</h2>
              </Carousel.Caption>
              <p className="greeting-2">
                ♥️Coming soon, we appreciate your patience.♥️
              </p>
            </Carousel.Item>
          ))}
        </Carousel>
